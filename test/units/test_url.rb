  ...
  context "with a client" do
    ...
    context "and an expanded url" do
      context "getting click data" do
        setup do
          stub_get("http://api.bitly.com/v3/clicks?hash=9uX1TE&login=test_account&apiKey=test_key", ['9uX1TEclicks.json', '9uX1TEclicks2.json'])
      ...
      context "getting info" do
        setup do
          stub_get("http://api.bitly.com/v3/info?hash=9uX1TE&login=test_account&apiKey=test_key", ['9uX1TEinfo.json', '9uX1TEinfo2.json'])
          @url = Bitly::Url.new(@bitly, 'hash' => '9uX1TE')
        end
      ...
      context "getting referrers" do
        setup do
          stub_get("http://api.bitly.com/v3/referrers?hash=djZ9g4&login=test_account&apiKey=test_key", ['referrer_hash.json', 'referrer_hash2.json'])
      ...
      context "getting countries" do
        setup do
          stub_get("http://api.bitly.com/v3/countries?hash=djZ9g4&login=test_account&apiKey=test_key", ['country_hash.json', 'country_hash2.json'])
          @url = Bitly::Url.new(@bitly, 'hash' => 'djZ9g4')
        end
      ...
      context "getting clicks by minute" do
        setup do
          ...
          stub_get("http://api.bitly.com/v3/clicks_by_minute?shortUrl=#{CGI.escape(@short_url)}&login=test_account&apiKey=test_key", ['clicks_by_minute1_url.json', 'clicks_by_minute2_url.json'])
      ...
      context "getting clicks by day" do
        setup do
          @hash = "9DguyN"
          stub_get("http://api.bitly.com/v3/clicks_by_day?hash=#{@hash}&login=test_account&apiKey=test_key", ['clicks_by_day1.json', 'clicks_by_day2.json'])
