...
class TestClient < Test::Unit::TestCase
  context "bitly module" do
    should "create a new bitly client" do
      silence_warnings { @b = Bitly.new(login, api_key) }
      assert_equal Bitly::V2::Client, @b.class
    end
  end

  context "using the bitly client" do
    setup do
      silence_warnings { @bitly = Bitly.new(login, api_key) }
    end
    ...
    context "shortening" do
      context "a single link" do
        ...
        should "return a Bitly::V2::Url" do
          assert_kind_of Bitly::V2::Url, @url
        end
      ...
      context "multiple links" do
        ...
        should "return an array of Bitly::V2::Urls" do
          assert_kind_of Array, @urls
          assert_kind_of Bitly::V2::Url, @urls[0]
        end
    ...
    context "expanding" do
      ...
      context "multiple hashes" do
        ...
        should "return an array of Bitly::Urls" do
          assert_kind_of Array, @urls
          assert_kind_of Bitly::V2::Url, @urls[0]
          assert_kind_of Bitly::V2::Url, @urls[1]
        end
